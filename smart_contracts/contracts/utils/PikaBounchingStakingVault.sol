 ...
 * ** package : @contracts/ERC721/PikaBounchingStakingVault.sol
 */
pragma solidity 0.8.17;

import "../interfaces/IPikaBounchingNft.sol";
import "../interfaces/IPikaBounchingCoin.sol";
...
contract PikaBounchingStakingVault is Ownable, IERC721Receiver {
    ...
    IPikaBounchingNft nft;
    IPikaBounchingCoin rewardCoin;
    ...
    constructor(address _nftAddress, address _tokenAddress) {
        nft = IPikaBounchingNft(_nftAddress);
        rewardCoin = IPikaBounchingCoin(_tokenAddress);
    }
